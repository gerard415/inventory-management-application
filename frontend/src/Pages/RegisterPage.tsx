...
const RegisterPage= () => {
  return (
      <div className="min-w-screen min-h-screen font-poppins flex items-center justify-center px-5 py-5 bg-gray-200">
                        ...
                        <div className="flex -mx-3">
                            <div className="w-full px-3 mb-12">
                                ...
                                <div className="flex">
                                    ...
                                    <input id='password' type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-blue-500" placeholder="************"/>
                                </div>
                            </div>
                        </div>
