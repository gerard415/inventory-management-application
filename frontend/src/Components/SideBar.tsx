...
const SideBar = () => {
    ...
    return (
        <div className='w-[250px] h-screen  flex flex-col space-y-8 shadow-md fixed top-0 left-0 text-gray-500 '>
            <div className='flex items-center  border pl-9 font-bold border-b-gray-300 h-[70px] text-sky-900 text-[30px] ' >
                StockX
            </div>
            <br />
