        ...
        <div className=" space-y-3 p-4">
            ...
            > 
                <label
                    ...
                    className={dragActive ? "relative cursor-pointer flex min-h-[100px] items-center justify-center rounded-md border-2 border-dashed  border-blue-400 p-12 text-center bg-gray-200" 
                    : "relative cursor-pointer flex min-h-[100px] items-center justify-center rounded-md border-2 border-dashed  border-gray-300 p-12 text-center" }
                >
                    <div>
                        <div className='flex items-center justify-center'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={0.8} stroke="currentColor" className="w-[100px] h-[50px]"> 
            ...
            <div className=" rounded-md h-[110px] ">
